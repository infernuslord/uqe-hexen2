...
int CopyLump (int lump, void *dest, int size)
{
	...
	if (length % size)
		logerror ("LoadBSPFile: odd lump size"); // jkrige - was Error()
...
// swap the header
	...
	if (header->version != BSPVERSION)
		logerror ("%s is version %i, not %i", filename, i, BSPVERSION); // jkrige - was Error()
