...
extern qboolean textures; // jkrige - .wal texture support
...
#define	NUM_HULLS		6				// normal and +16
...
extern int LightValues[MAX_MAP_CLIPNODES];
...
extern	char	projectpath[1024];	// with a trailing slash, for finding wads
