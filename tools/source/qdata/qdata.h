...
#include "scriplib.h"
#include "mathlib.h"
//#include "trilib.h" // jkrige
#include "lbmlib.h"
//#include "threads.h" // jkrige
//#include "l3dslib.h" // jkrige
//#include "bspfile.h" // jkrige
#include "qfiles.h" // jkrige - texture flags
...
void Cmd_Load (void); // jkrige - copied from sprite.c
void Cmd_Grab (void);
void Cmd_Raw (void);
void Cmd_Mip (void);
