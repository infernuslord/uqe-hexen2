/*
 * $Header: /cvsroot/uhexen2/gamecode/hc/siege/subs.hc,v 1.2 2007-02-07 17:01:25 sezero Exp $
 */
...
//
	if(activator.classname == "player")
		...
		else if(self.netname!=""&&self.solid==SOLID_TRIGGER)
		{
			centerprint (activator, self.netname);
			if(!self.noise)
				sound (activator, CHAN_VOICE, "misc/comm.wav", 1, ATTN_NORM);
		}
