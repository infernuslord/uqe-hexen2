...
float STR_ARROWS			= 593;//" arrows"

//float STR_INFRAVISION		= 594;//"InfraVision"
//float STR_REGENERATOIN	= 595;//"Regeneration"

float STR_BLOWNUP			= 596;//" was blown up by "
float STR_CRACKSHOT			= 597;//"'s crackshot barrel tossin'!^"
float STR_SKEWERED			= 598;//" was skewered by "
