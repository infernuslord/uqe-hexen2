...
cvar_t	gl_clear = {"gl_clear", "1"}; // jkrige - changed gl_clear value from 0 to 1
...
// jkrige - texture mode
cvar_t	gl_texturemode = {"gl_texturemode", "2", true};
// jkrige - texture mode
...
=============
*/
int trickframe; // jkrige - skyshaders
