...
char *svc_strings[] =
{
	...
	"svc_toggle_statbar",
	"svc_sound_update_pos",	// jkrige
	"svc_mod_name",			// jkrige - fmod sound system (music)
...
void CL_ParseStartSoundPacket(void)
{
	...
	// jkrige - increase sound precache
    //if (field_mask & SND_OVERFLOW)
	//	sound_num += 255;
	if (field_mask & SND_OVERFLOW)
		sound_num += 256; // jkrige - was 255
...
// parse protocol version number
	i = MSG_ReadLong ();
	// jkrige - increased protocol version (changes made on CL_ParseServerMessage() )
...
//
	...
	for (i=2 ; i<nummodels ; i++)
	{
		...
		{
			// jkrige - client segmentation fault when pure h2 client connecting to mission pack server
	...
	// jkrige - old mission cvar
	//if(!m_oldmission.value)
	if(hexen2_portals) // jkrige - portals game
...
char	orig_worldmodel[59][64];

void CL_WorldModels (void)
{
	if(strlen(orig_worldmodel[0]))
		return;

	strcpy(orig_worldmodel[0], "maps/demo1.bsp");
	strcpy(orig_worldmodel[1], "maps/demo2.bsp");
	strcpy(orig_worldmodel[2], "maps/demo3.bsp");
	strcpy(orig_worldmodel[3], "maps/ravdm1.bsp");
	strcpy(orig_worldmodel[4], "maps/castle4.bsp");
	strcpy(orig_worldmodel[5], "maps/castle5.bsp");
	strcpy(orig_worldmodel[6], "maps/cath.bsp");
	strcpy(orig_worldmodel[7], "maps/egypt1.bsp");
	strcpy(orig_worldmodel[8], "maps/egypt2.bsp");
	strcpy(orig_worldmodel[9], "maps/egypt3.bsp");
	strcpy(orig_worldmodel[10], "maps/egypt4.bsp");
	strcpy(orig_worldmodel[11], "maps/egypt5.bsp");
	strcpy(orig_worldmodel[12], "maps/egypt6.bsp");
	strcpy(orig_worldmodel[13], "maps/egypt7.bsp");
	strcpy(orig_worldmodel[14], "maps/eidolon.bsp");
	strcpy(orig_worldmodel[15], "maps/meso1.bsp");
	strcpy(orig_worldmodel[16], "maps/meso2.bsp");
	strcpy(orig_worldmodel[17], "maps/meso3.bsp");
	strcpy(orig_worldmodel[18], "maps/meso4.bsp");
	strcpy(orig_worldmodel[19], "maps/meso5.bsp");
	strcpy(orig_worldmodel[20], "maps/meso6.bsp");
	strcpy(orig_worldmodel[21], "maps/meso8.bsp");
	strcpy(orig_worldmodel[22], "maps/meso9.bsp");
	strcpy(orig_worldmodel[23], "maps/ravdm2.bsp");
	strcpy(orig_worldmodel[24], "maps/ravdm3.bsp");
	strcpy(orig_worldmodel[25], "maps/ravdm4.bsp");
	strcpy(orig_worldmodel[26], "maps/ravdm5.bsp");
	strcpy(orig_worldmodel[27], "maps/rider1a.bsp");
	strcpy(orig_worldmodel[28], "maps/rider2c.bsp");
	strcpy(orig_worldmodel[29], "maps/romeric1.bsp");
	strcpy(orig_worldmodel[30], "maps/romeric2.bsp");
	strcpy(orig_worldmodel[31], "maps/romeric3.bsp");
	strcpy(orig_worldmodel[32], "maps/romeric4.bsp");
	strcpy(orig_worldmodel[33], "maps/romeric5.bsp");
	strcpy(orig_worldmodel[34], "maps/romeric6.bsp");
	strcpy(orig_worldmodel[35], "maps/romeric7.bsp");
	strcpy(orig_worldmodel[36], "maps/tower.bsp");
	strcpy(orig_worldmodel[37], "maps/village1.bsp");
	strcpy(orig_worldmodel[38], "maps/village2.bsp");
	strcpy(orig_worldmodel[39], "maps/village3.bsp");
	strcpy(orig_worldmodel[40], "maps/village4.bsp");
	strcpy(orig_worldmodel[41], "maps/village5.bsp");

	// Portal of Preavus
	strcpy(orig_worldmodel[42], "maps/keep1.bsp");
	strcpy(orig_worldmodel[43], "maps/keep2.bsp");
	strcpy(orig_worldmodel[44], "maps/keep3.bsp");
	strcpy(orig_worldmodel[45], "maps/keep4.bsp");
	strcpy(orig_worldmodel[46], "maps/keep5.bsp");
	strcpy(orig_worldmodel[47], "maps/monsters.bsp");
	strcpy(orig_worldmodel[48], "maps/thomas.bsp");
	strcpy(orig_worldmodel[49], "maps/tibet1.bsp");
	strcpy(orig_worldmodel[50], "maps/tibet2.bsp");
	strcpy(orig_worldmodel[51], "maps/tibet3.bsp");
	strcpy(orig_worldmodel[52], "maps/tibet4.bsp");
	strcpy(orig_worldmodel[53], "maps/tibet5.bsp");
	strcpy(orig_worldmodel[54], "maps/tibet6.bsp");
	strcpy(orig_worldmodel[55], "maps/tibet7.bsp");
	strcpy(orig_worldmodel[56], "maps/tibet8.bsp");
	strcpy(orig_worldmodel[57], "maps/tibet9.bsp");
	strcpy(orig_worldmodel[58], "maps/tibet10.bsp");
...
//			Con_Printf ("svc_nop\n");
		...
		case svc_version:
			...
			*/
			if (i != PROTOCOL_VERSION_RAVEN_112 && i != PROTOCOL_VERSION_UQE_113)
				...
				Con_DPrintf ("Server using protocol %i\n", i);
			// jkrige - increased protocol version (changes made on CL_ParseServerMessage() )
			break;
		...
		case svc_cdtrack:
			...
			if (strcmpi(bgmtype.string,"cd") == 0)
			{
				...
				FMOD_MusicStart (NULL, cdtrack, true, false, false);
				// jkrige - fmod sound system (music)
			}
			
			if ( (cls.demoplayback || cls.demorecording) )
				goto svc_mod_name_dem;
			break;
		...
		case svc_midi_name:
			...
			//	MIDI_Stop();
			if (strcmpi(bgmtype.string, "midi") == 0)
				FMOD_MusicStart (cl.midi_name, 0, true, false, false);
			// jkrige - fmod sound system (music)
			break;

		// jkrige - fmod sound system (music)
		case svc_mod_name:
			strcpy(cl.mod_name, MSG_ReadString ());
svc_mod_name_dem:
			if (strcmpi(bgmtype.string, "mod") == 0)
			{
				if (!strlen(cl.mod_name))
				{
					CL_WorldModels();

					for(wmodels = 0; wmodels < 59; wmodels++)
					{
						if (strcmpi(cl.worldmodel->name, orig_worldmodel[wmodels]) == 0)
						{
							if ( (cls.demoplayback || cls.demorecording) && (cls.forcetrack != -1) )
							{
								if(cls.forcetrack == 1)
								...
								if(cls.forcetrack <= 9)
								{
									//if(m_oldmission.value)
									if(hexen2_portals) // jkrige - portals game
										sprintf(cl.mod_name, "mp_track0%i", cls.forcetrack);
									else
										sprintf(cl.mod_name, "track0%i", cls.forcetrack);
								}
								else
								{
									//if(m_oldmission.value)
									if(hexen2_portals) // jkrige - portals game
										sprintf(cl.mod_name, "mp_track%i", cls.forcetrack);
									else
										sprintf(cl.mod_name, "track%i", cls.forcetrack);
								}
							}
							else
							{
								if (cl.cdtrack)
								{
									if(cl.cdtrack <= 9)
									{
										//if(m_oldmission.value)
										if(hexen2_portals) // jkrige - portals game
											sprintf(cl.mod_name, "mp_track0%i", cl.cdtrack);
										else
											sprintf(cl.mod_name, "track0%i", cl.cdtrack);
									}
									else
									{
										//if(m_oldmission.value)
										if(hexen2_portals) // jkrige - portals game
											sprintf(cl.mod_name, "mp_track%i", cl.cdtrack);
										else
											sprintf(cl.mod_name, "track%i", cl.cdtrack);
									}
								}
							}
						}
				...
				FMOD_MusicStart (cl.mod_name, 0, true, false, false);
			}
			break;
		// jkrige - fmod sound system (music)
		...
		case svc_intermission:
			...
			// jkrige - fix demo record/playback in intermission
