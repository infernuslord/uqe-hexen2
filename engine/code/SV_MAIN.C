...
//		dedicated server FPS cap, default 20 (no need to run at higher speed).
//		Note: listen servers (including SP) will run at a different cap, defined by cl_maxfps.
cvar_t sv_fps = {"sv_fps", "20", true};
// jkrige - configurable fps caps
